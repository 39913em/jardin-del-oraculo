...
renderer.domElement.addEventListener('click', async e => {
  ...
  if (hitsSprite.length) {
    ...
    let html = `<div style="text-align:center;border-bottom:2px solid #ff6b35;padding-bottom:15px;margin-bottom:15px">
      ...
      <p style="font-size:11px;color:#666;letter-spacing:1px;text-transform:uppercase">Jardín del Oráculo</p></div>`;
    ...
    html += `<div style="margin-top:25px;border-top:1px solid #ddd;padding-top:12px;text-align:center;font-size:10px;color:#999">Jardín del Oráculo · ${new Date().toLocaleDateString()}</div>`;
